        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrossValue = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
                    NetValue = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinQuantity = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceValue = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
                    DiscountPercentage = table.Column<decimal>(type: "numeric(5,2)", nullable: false, defaultValue: 0m),
                    DiscountValue = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
                    NetValue = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubLocations_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
